...
with st.sidebar:
    ...
    selected = option_menu('Menu',
                           ['Welcome', 'Pregnancy Risk Prediction', 'Fetal Health Prediction', 'Dashboard'],
                           icons=['chat-square-text', 'hospital', 'capsule-pill', 'clipboard-data'],
                           default_index=0)

if selected == 'Welcome':
    st.title("Welcome to Mother & Baby Care")
    st.write("At Mother & Baby Care, our mission is to revolutionize healthcare by offering innovative solutions "
             "through predictive analysis. Our platform is specifically designed to address the intricate aspects of "
    ...
    with col1:
        ...
        st.write("Our Pregnancy Risk Prediction feature utilizes advanced algorithms to analyze various parameters, "
                 "including age, body sugar levels, blood pressure, and more. By processing this information, we provide "
                 "accurate predictions of potential risks during pregnancy.")
    ...
    with col2:
        ...
        st.write("Fetal Health Prediction is a crucial aspect of our system. We leverage cutting-edge technology to assess "
                 "the health status of the fetus. Through a comprehensive analysis of factors such as ultrasound data, "
                 "maternal health, and genetic factors, we deliver insights into the well-being of the unborn child.")
    ...
    st.write("Thank you for choosing E-Doctor. We are committed to advancing healthcare through technology and predictive "
             "analytics. Feel free to explore our features and take advantage of the insights we provide.")
...
if selected == 'Pregnancy Risk Prediction':
    ...
    with col2:
        diastolicBP = st.text_input('Diastolic BP in mmHg', key="dbp")
    with col3:
